...
?>
    ...
    $stid = oci_parse($conn, 'SELECT p.nrodocumentop,p.apellido,p.nombre,p.fnacimiento,p.direccion,
                                    t.ingresostotales,t.cantfamiliares,t.ingresosretenidos
                                FROM final.persona p INNER JOIN final.titular t 
                                        ON p.nrodocumentop = t.nrodocumentot');
    oci_execute($stid);
    ...
    <div class="container my-5">
        <div class="card card-signin">
            <div class="card-body table-responsive">
                <h5 class="card-title text-center">Listado de Titulares</h5>
                <!-- abrimos cosigo php para cargar los datos de la tabla persona y titular -->
                <?php

                // en php creamos la tabla que mostrara los datos de los titulares
                echo "<table class='table table-sm table-striped'>";

                //definimos el caption para nuestra tabla
                echo "<caption>Lista de titulares</caption>";
                ...
                echo "<th scope='col'> INGRESOS TOTALES </th>";
                echo "<th scope='col'> CANTIDAD FAMILIARES </th>";
                echo "<th scope='col'> INGRESOS RETENIDOS </th>";
                echo "</tr>";
